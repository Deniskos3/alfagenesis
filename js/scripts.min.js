...
;(function (window, document, $, undefined) {
    ...
    if($('.menu-right').hasClass("full_opened_menu")){
        ...
        $(this).closest('.menu-right').find('.container-scroll').css("width","40%");
        console.log("не видим");
    }else{
        $(this).closest('.menu-right').find('.mCSB_scrollTools').removeAttr("style");
        $(this).closest('.menu-right').find('.mCSB_scrollTools').attr('style',  'display: none !important');
        $(this).closest('.menu-right').find('.container-scroll').css("width","1210px");
        console.log("не видим");
    }
    });
...
$(function() {
    ...
    inputone.oninput = function(data) {
