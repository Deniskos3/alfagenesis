...
$(function() {
   $(".menu-right").hover(function(){
      if(this.classList.contains('full_opened_menu')){
          console.log("marinf");
      }
   })
    ...
    $('.btn-plus').on('click',function(){
        ...
        // $('#butstrsite').value='плюс,которая находится в услуге или опции с названием:' + pricename;
    })
    $(".btn-plus").on('click', function () {
    }).magnificPopup({
        type: "inline",
    ...
    $(".callback-chat").on("click",function(){
    ...
    $('.control-arrow').click(function() {
        // let cont=  $(this).closest('.menu-right').find('.container-scroll');
        // if($(cont).css('width') == "650px"){
        
        // $(cont).css("width","650px");
        // }else{
        //  $(cont).css("width","100%");   
        // }
    });
