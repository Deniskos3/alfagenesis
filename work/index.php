    ...
    <div id="modal">
        <div class="hidden">
            <form  method="POST" id="callback" class="callback-form forms" enctype="multipart/form-data">
                ...
                <input id="strsite" name="strsite" type="hidden" value=" где находится-Процесс разработки">
            ...
            <div class="container-custom">
                <div class="flex-wrapper-screen">
                    <div class="flex-wrapper-screen-row">
                        ...
                        <div class="form-control-btn form-control-btn-fit mr-40">
                            <a class="btn-form-callback wrapper-callback-form-open" href="#callback">Заказать проект</a>
                        </div>
                    </div>
                    <div class="info-main">
                        <h1>Процесс разработки</h1>
                        <div class="container-content-work">
                            <svg class="wave-desktop" width="1715" height="280" viewBox="0 0 1715 280" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0 63.8566C8.50715 46.2624 35.73 13.8332 76.5644 24.8695C156.191 50.0611 633.953 311.574 823.833 274.386C1013.71 237.199 1218.9 5.67592 1401.64 2.07711C1547.83 -0.801927 1670.12 77.6519 1713 117.239" stroke="#EAEAEA" stroke-width="3" stroke-dasharray="30 30"/>
                            </svg>
                            <svg class="wave-mobile" width="200" height="2297" viewBox="0 0 200 2297" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M45.9271 2295C33.4327 2283.61 10.4033 2247.15 18.2407 2192.47C36.1304 2085.83 221.842 1446.03 195.434 1191.75C169.025 937.466 4.61043 662.678 2.05476 417.967C0.0102259 222.197 55.7239 58.4184 83.8362 1.00007" stroke="#EAEAEA" stroke-width="3" stroke-dasharray="30 30"/>
                            </svg>
                            <div class="js-page-scroll">
                                <div class="js-page-scroll-main">
                                    <div class="js-page-scroll-section">
                                        <div class="wrapper-cards-work">
                                            <div class="card-work">
                                                ...
                                                <div class="card-work-middle">
                                                    <div class="card-work-icon">
                                                        <svg width="47" height="43" viewBox="0 0 47 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M40.1293 0.301758H6.82289C3.34057 0.301758 0.507324 3.13444 0.507324 6.61732V27.0001C0.507324 30.4752 3.32823 33.3034 6.80046 33.3157V42.5652L20.093 33.3157H40.1293C43.6116 33.3157 46.4448 30.4824 46.4448 27.0001V6.61732C46.4448 3.13444 43.6116 0.301758 40.1293 0.301758ZM43.7532 27.0001C43.7532 28.9981 42.1275 30.624 40.1293 30.624H19.2485L9.49211 37.4132V30.624H6.82289C4.82462 30.624 3.19897 28.9981 3.19897 27.0001V6.61732C3.19897 4.61877 4.82462 2.99341 6.82289 2.99341H40.1293C42.1275 2.99341 43.7532 4.61877 43.7532 6.61732V27.0001Z" fill="#1A1A1A"/>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="card-work-bottom">
                                                    <p class="card-work-description">Понимаем все ваши предпочтения и желание сделать проект лучшим</p>
                                                    <div class="card-work-link">
                                                        <a href="../img/files/brif.pdf" class="fancybox" data-fancybox-type="iframe">Напишите нам в Телеграм или Вконтакте</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card-work-middle">
                                                    <div class="card-work-icon">
                                                        <svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M40.8487 21.2031H35.2423C32.402 21.2031 30.091 23.5141 30.091 26.3544V40.8487C30.091 43.689 32.402 46 35.2423 46H40.8487C43.689 46 46 43.689 46 40.8487V26.3544C46 23.5141 43.689 21.2031 40.8487 21.2031ZM42.4062 40.8487C42.4062 41.7075 41.7075 42.4062 40.8487 42.4062H35.2423C34.3835 42.4062 33.6847 41.7075 33.6847 40.8487V26.3544C33.6847 25.4956 34.3835 24.7969 35.2423 24.7969H40.8487C41.7075 24.7969 42.4062 25.4956 42.4062 26.3544V40.8487ZM15.909 19.6456V5.15128C15.909 2.31102 13.598 0 10.7577 0H5.15128C2.31102 0 0 2.31102 0 5.15128V19.6456C0 22.4859 2.31102 24.7969 5.15128 24.7969H10.7577C13.598 24.7969 15.909 22.4859 15.909 19.6456ZM3.59375 19.6456V5.15128C3.59375 4.2925 4.2925 3.59375 5.15128 3.59375H10.7577C11.6165 3.59375 12.3153 4.2925 12.3153 5.15128V19.6456C12.3153 20.5044 11.6165 21.2031 10.7577 21.2031H5.15128C4.2925 21.2031 3.59375 20.5044 3.59375 19.6456ZM30.5227 3.59375C27.3655 3.59375 24.7969 6.16237 24.7969 9.31953V36.6805C24.7969 41.8191 20.616 46 15.4773 46C10.3383 46 6.15746 41.8191 6.15746 36.6805V30.0678C6.15746 29.0753 6.96219 28.271 7.95433 28.271C8.94682 28.271 9.75121 29.0753 9.75121 30.0678V36.6805C9.75121 39.8376 12.3202 42.4062 15.4773 42.4062C18.6345 42.4062 21.2031 39.8376 21.2031 36.6805V9.31953C21.2031 4.18089 25.384 0 30.5227 0C35.6617 0 39.8425 4.18089 39.8425 9.31953V15.9322C39.8425 16.9247 39.0378 17.729 38.0457 17.729C37.0532 17.729 36.2488 16.9247 36.2488 15.9322V9.31953C36.2488 6.16237 33.6802 3.59375 30.5227 3.59375Z" fill="#1A1A1A"/>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="card-work-bottom">
                                                    ...
                                                    <div class="card-work-link">
                                                        <a href="../img/files/analyze.pdf" class="fancybox" data-fancybox-type="iframe">
                                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                ...
                                                                <path d="M9.7046 14.417H5.54185C5.30519 14.417 5.11328 14.6089 5.11328 14.8456C5.11328 15.0823 5.30519 15.2741 5.54185 15.2741H9.7046C9.94126 15.2741 10.1332 15.0823 10.1332 14.8456C10.1332 14.6089 9.9413 14.417 9.7046 14.417Z" fill="black"/>
                                                                <path d="M15.4582 12.458H5.5421C5.30544 12.458 5.11353 12.6499 5.11353 12.8866C5.11353 13.1233 5.30544 13.3152 5.5421 13.3152H15.4582C15.6948 13.3152 15.8867 13.1233 15.8867 12.8866C15.8867 12.6499 15.6948 12.458 15.4582 12.458Z" fill="black"/>
                                                                <path d="M15.4582 10.5H5.5421C5.30544 10.5 5.11353 10.6919 5.11353 10.9286C5.11353 11.1653 5.30544 11.3571 5.5421 11.3571H15.4582C15.6948 11.3571 15.8867 11.1653 15.8867 10.9286C15.8867 10.6919 15.6948 10.5 15.4582 10.5Z" fill="black"/>
                                                                <path d="M15.4582 8.54199H5.5421C5.30544 8.54199 5.11353 8.73386 5.11353 8.97056C5.11353 9.20726 5.30544 9.39914 5.5421 9.39914H15.4582C15.6948 9.39914 15.8867 9.20726 15.8867 8.97056C15.8867 8.73386 15.6948 8.54199 15.4582 8.54199Z" fill="black"/>
                                                            </svg>
                                                            Пример планирования</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="js-page-scroll-section">
                                        <div class="wrapper-cards-work">
                                            <div class="card-work">
                                                <div class="card-work-top">
                                                    <p class="card-work-stage">Шаг 3</p>
                                                    <p class="card-work-header">Дизайн</p>
                                                </div>
                                                <div class="card-work-middle">
                                                    <div class="card-work-icon">
                                                        <svg width="51" height="45" viewBox="0 0 51 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M47.4632 0H3.0494C1.36798 0 0 1.36798 0 3.0494V33.714C0 35.3954 1.36798 36.7634 3.0494 36.7634H18.2683V38.9822C18.2683 41.0162 16.6134 42.6711 14.5794 42.6711H11.2253C10.5823 42.6711 10.0609 43.1924 10.0609 43.8355C10.0609 44.4787 10.5823 45 11.2253 45H39.287C39.9301 45 40.4515 44.4787 40.4515 43.8355C40.4515 43.1924 39.9301 42.6711 39.287 42.6711H35.9329C33.8989 42.6711 32.244 41.0162 32.244 38.9822V36.7635H47.4629C49.1443 36.7635 50.5124 35.3955 50.5124 33.7141V3.0494C50.5126 1.36798 49.1446 0 47.4632 0ZM19.329 42.6713C20.1228 41.6516 20.5974 40.3718 20.5974 38.9824V36.7636H29.9153V38.9824C29.9153 40.3718 30.3899 41.6517 31.1837 42.6713H19.329ZM48.1837 33.7141C48.1837 34.1114 47.8605 34.4347 47.4631 34.4347H3.0494C2.65211 34.4347 2.32881 34.1115 2.32881 33.7141V27.5941H48.1837V33.7141ZM48.1837 25.2651H2.32891V3.0494C2.32891 2.65211 2.65211 2.32881 3.0495 2.32881H47.4631C47.8604 2.32881 48.1838 2.65201 48.1838 3.0494V25.2651H48.1837Z" fill="black"/>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="card-work-bottom">
                                    ...
                                    <div class="js-page-scroll-section">
                                        <div class="wrapper-cards-work">
                                            <div class="card-work">
                                                <div class="card-work-top">
                                                    <p class="card-work-stage">Шаг 4</p>
                                                    <p class="card-work-header">Верстка</p>
                                                </div>
                                                <div class="card-work-middle">
                                                    <div class="card-work-icon">
                                                        <svg width="53" height="53" viewBox="0 0 53 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M44.4455 9.73411L52.0258 2.15592L49.8706 0L42.3003 7.56813H9.5386V1.07801H6.49011V7.56813H0V10.6166H6.49011V45.5235H41.397V52.0136H44.4455V45.5235H50.9356V42.475H44.4455V9.73411ZM9.5386 10.6167H39.2509L9.5386 40.3204V10.6167ZM41.3971 42.4751H41.397H11.6952L41.3971 12.7819V42.4751Z" fill="#1A1A1A"/>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="card-work-bottom">
                                                    ...
                                                    <div class="card-work-link">
                                                        <a href="#" class="fancybox" data-fancybox-type="iframe">
                                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M19.0312 5.2034L13.9533 0.125549C13.8728 0.0451581 13.7639 0 13.6502 0H3.92636C2.77784 0 1.84351 0.934416 1.84351 2.08293V18.9171C1.84351 20.0656 2.77788 21 3.9264 21H17.0738C18.2223 21 19.1567 20.0656 19.1567 18.9171V5.50646C19.1567 5.39281 19.1115 5.28379 19.0312 5.2034ZM14.0789 1.46339L17.6935 5.07793H15.3046C14.9772 5.07793 14.6693 4.95041 14.4378 4.71892C14.2064 4.48747 14.0789 4.17965 14.0789 3.85222V1.46339ZM18.2995 18.9171C18.2995 19.593 17.7497 20.1428 17.0738 20.1428H3.92636C3.25046 20.1428 2.70061 19.593 2.70061 18.9171V2.08293C2.70065 1.40704 3.2505 0.857143 3.92636 0.857143H13.2218V3.85214C13.2217 4.40851 13.4383 4.93159 13.8317 5.32497C14.2251 5.71839 14.7482 5.93503 15.3046 5.93503H18.2995V18.9171H18.2995Z" fill="black"/>
                                                                <path d="M11.283 14.417H11.0912C10.8545 14.417 10.6626 14.6089 10.6626 14.8456C10.6626 15.0823 10.8545 15.2741 11.0912 15.2741H11.283C11.5197 15.2741 11.7116 15.0823 11.7116 14.8456C11.7116 14.6089 11.5197 14.417 11.283 14.417Z" fill="black"/>
                                                                <path d="M9.7046 14.417H5.54185C5.30519 14.417 5.11328 14.6089 5.11328 14.8456C5.11328 15.0823 5.30519 15.2741 5.54185 15.2741H9.7046C9.94126 15.2741 10.1332 15.0823 10.1332 14.8456C10.1332 14.6089 9.9413 14.417 9.7046 14.417Z" fill="black"/>
                                    ...
                                    <div class="js-page-scroll-section">
                                        <div class="wrapper-cards-work">
                                            <div class="card-work">
                                                <div class="card-work-top">
                                                    <p class="card-work-stage">Шаг 5</p>
                                                    <p class="card-work-header">Програмирование</p>
                                                </div>
                                                <div class="card-work-middle">
                                                    <div class="card-work-icon">
                                                        <svg width="43" height="43" viewBox="0 0 43 43" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M42.7025 0.297486C42.503 0.0981191 42.2308 -0.00994315 41.9479 0.00072089C41.7182 0.00894744 36.2506 0.228728 29.7511 2.52597C24.543 4.36485 20.202 6.99765 16.8485 10.3512C16.097 11.1027 15.3658 11.8996 14.6661 12.7274C11.3503 10.7756 8.69321 11.3876 7.01347 12.2865C3.14588 14.3564 0.751953 19.9764 0.751953 23.9962C0.752258 24.407 0.999765 24.7774 1.3792 24.9345C1.50483 24.9866 1.63687 25.0119 1.76768 25.0119C2.03204 25.0119 2.29174 24.9086 2.48603 24.7144C4.52571 22.6747 7.0415 22.8023 7.86335 22.9103L8.21902 23.266C7.51905 24.9316 6.95518 26.5879 6.54162 28.1988C6.39232 28.7818 6.44269 29.3986 6.66461 29.9629C5.68677 30.4136 4.74335 31.0752 3.92192 31.8967C1.3076 34.5111 0.776735 40.8825 0.755407 41.1525C0.732047 41.4487 0.8395 41.7404 1.04963 41.9505C1.24087 42.1417 1.49955 42.248 1.76768 42.248C1.79429 42.248 1.821 42.247 1.84771 42.2449C2.11766 42.2236 8.48928 41.6928 11.1036 39.0784C11.9247 38.2573 12.5863 37.314 13.0369 36.3364C13.6343 36.5713 14.2492 36.6002 14.8021 36.4585C16.4123 36.0451 18.0683 35.4814 19.7342 34.7813L20.0898 35.137C20.1978 35.959 20.3253 38.4748 18.2858 40.5142C17.9954 40.8047 17.9085 41.2415 18.0657 41.621C18.2228 42.0005 18.5931 42.2479 19.0039 42.2479C23.0238 42.2479 28.6437 39.854 30.7136 35.9864C31.6125 34.3068 32.2245 31.6498 30.2727 28.3339C31.1001 27.6345 31.8971 26.9033 32.6488 26.1515C36.0024 22.7979 38.6351 18.4568 40.474 13.2491C42.7713 6.74933 42.991 1.28162 42.9992 1.05209C43.0094 0.770259 42.9018 0.496954 42.7025 0.297486ZM3.02268 21.8117C3.65359 18.7585 5.48608 15.408 7.97232 14.0774C9.63378 13.1883 11.4498 13.2754 13.3807 14.3324C11.7357 16.4959 10.3056 18.8267 9.11358 21.2881C9.09845 21.2787 8.91563 21.0489 8.57601 20.9723C8.43636 20.9407 5.74912 20.3627 3.02268 21.8117ZM9.6673 37.6421C8.27082 39.0385 4.99492 39.7751 2.92437 40.0758C3.2252 38.0051 3.96183 34.7293 5.35821 33.333C6.14024 32.5509 7.04699 31.958 7.95841 31.6241L11.3762 35.0419C11.0422 35.9533 10.4494 36.86 9.6673 37.6421ZM14.2975 34.4909C14.0036 34.5661 13.6632 34.4556 13.4101 34.2029C12.0962 32.889 11.5822 32.375 11.4209 32.2139C11.1251 31.9181 10.3999 31.1928 8.79792 29.5908C8.54463 29.337 8.43413 28.9967 8.50918 28.7032C8.83449 27.4364 9.25993 26.1366 9.77729 24.8243L18.176 33.223C16.8635 33.7404 15.5639 34.1658 14.2975 34.4909ZM28.9229 35.0279C27.5922 37.5141 24.2419 39.3467 21.1887 39.9775C22.1622 38.1456 22.3768 35.8136 22.0211 34.3996C21.9386 34.0711 21.7243 33.906 21.7123 33.8866C24.1734 32.6945 26.5042 31.2644 28.6679 29.6194C29.7248 31.5505 29.8119 33.3668 28.9229 35.0279ZM31.2127 24.7152C30.2976 25.6303 29.3121 26.5144 28.2837 27.3428C25.8114 29.3334 23.0904 31.0196 20.1873 32.3618L10.6384 22.8131C11.9807 19.9099 13.6668 17.1888 15.6572 14.7169C16.4864 13.6878 17.3704 12.7022 18.2852 11.7875C21.294 8.77865 25.1771 6.38401 29.8299 4.6603L38.34 13.1704C36.6165 17.8231 34.2218 21.7062 31.2127 24.7152ZM39.0707 11.0284L31.9719 3.92956C35.8395 2.72828 39.2042 2.27846 40.8836 2.11677C40.7218 3.79651 40.2719 7.16117 39.0707 11.0284Z" fill="#1A1A1A"/>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="card-work-bottom">
                                                    <p class="card-work-description">На этом этапе мы вдыхаем жизнь в проект за счет добавления функционала и работой с базами данных</p>
                                                    <div class="card-work-link">
                                                        <a href="#">
                                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M19.0312 5.2034L13.9533 0.125549C13.8728 0.0451581 13.7639 0 13.6502 0H3.92636C2.77784 0 1.84351 0.934416 1.84351 2.08293V18.9171C1.84351 20.0656 2.77788 21 3.9264 21H17.0738C18.2223 21 19.1567 20.0656 19.1567 18.9171V5.50646C19.1567 5.39281 19.1115 5.28379 19.0312 5.2034ZM14.0789 1.46339L17.6935 5.07793H15.3046C14.9772 5.07793 14.6693 4.95041 14.4378 4.71892C14.2064 4.48747 14.0789 4.17965 14.0789 3.85222V1.46339ZM18.2995 18.9171C18.2995 19.593 17.7497 20.1428 17.0738 20.1428H3.92636C3.25046 20.1428 2.70061 19.593 2.70061 18.9171V2.08293C2.70065 1.40704 3.2505 0.857143 3.92636 0.857143H13.2218V3.85214C13.2217 4.40851 13.4383 4.93159 13.8317 5.32497C14.2251 5.71839 14.7482 5.93503 15.3046 5.93503H18.2995V18.9171H18.2995Z" fill="black"/>
                                    ...
                                    <div class="js-page-scroll-section">
                                        <div class="wrapper-cards-work">
                                            <div class="card-work">
                                                <div class="card-work-top">
                                                    <p class="card-work-stage">Шаг 6</p>
                                                    <p class="card-work-header">Тестирование и сдача проекта</p>
                                                </div>
                                                <div class="card-work-middle">
                                                    <div class="card-work-icon">
                                                        <svg width="43" height="43" viewBox="0 0 48 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M22.5781 49.9688C22.5781 51.0907 21.6688 52 20.5469 52H8.86719C4.38693 52 0.742188 48.3553 0.742188 43.875V8.125C0.742188 3.64474 4.38693 0 8.86719 0H33.8405C38.3203 0 41.9655 3.64474 41.9655 8.125V29.6562C41.9655 30.7782 41.0558 31.6875 39.9342 31.6875C38.8123 31.6875 37.903 30.7782 37.903 29.6562V8.125C37.903 5.88507 36.0804 4.0625 33.8405 4.0625H8.86719C6.62726 4.0625 4.80469 5.88507 4.80469 8.125V43.875C4.80469 46.1149 6.62726 47.9375 8.86719 47.9375H20.5469C21.6688 47.9375 22.5781 48.8468 22.5781 49.9688ZM46.5104 33.0828C45.5983 32.4298 44.3296 32.64 43.6765 33.5517L33.6643 47.5372C33.391 47.8542 33.0482 47.9224 32.8649 47.9347C32.6753 47.947 32.3087 47.9232 31.9941 47.6237L25.5123 41.3998C24.7034 40.623 23.4176 40.6488 22.6404 41.4581C21.8632 42.2675 21.8894 43.5533 22.6987 44.33L29.1868 50.5603C30.1588 51.485 31.4557 52 32.7903 52C32.905 52 33.02 51.996 33.1351 51.9885C34.5887 51.8917 35.9459 51.1847 36.8588 50.0485C36.8822 50.0195 36.9052 49.9894 36.927 49.9588L46.9797 35.9166C47.6327 35.0045 47.4229 33.7358 46.5104 33.0828ZM31.8092 12.1875H10.8873C9.76538 12.1875 8.85608 13.0968 8.85608 14.2188C8.85608 15.3407 9.76538 16.25 10.8873 16.25H31.8092C32.9308 16.25 33.8405 15.3407 33.8405 14.2188C33.8405 13.0968 32.9308 12.1875 31.8092 12.1875ZM33.8405 22.3438C33.8405 21.2218 32.9308 20.3125 31.8092 20.3125H10.8873C9.76538 20.3125 8.85608 21.2218 8.85608 22.3438C8.85608 23.4657 9.76538 24.375 10.8873 24.375H31.8092C32.9308 24.375 33.8405 23.4657 33.8405 22.3438ZM10.8873 28.4375C9.76538 28.4375 8.85608 29.3468 8.85608 30.4688C8.85608 31.5907 9.76538 32.5 10.8873 32.5H23.5938C24.7157 32.5 25.625 31.5907 25.625 30.4688C25.625 29.3468 24.7157 28.4375 23.5938 28.4375H10.8873Z" fill="black"/>
                                                        </svg>
                                                    </div>
                                                </div>
                                                <div class="card-work-bottom">
                                                    <p class="card-work-description">Отдел тестирования проверяет сайт на соответствия с техническим заданием и дизайном и передает проект на проверку вам</p>
                                                    <div class="card-work-link">
                                                        <a href="/projects">
                                                            <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M19.0312 5.2034L13.9533 0.125549C13.8728 0.0451581 13.7639 0 13.6502 0H3.92636C2.77784 0 1.84351 0.934416 1.84351 2.08293V18.9171C1.84351 20.0656 2.77788 21 3.9264 21H17.0738C18.2223 21 19.1567 20.0656 19.1567 18.9171V5.50646C19.1567 5.39281 19.1115 5.28379 19.0312 5.2034ZM14.0789 1.46339L17.6935 5.07793H15.3046C14.9772 5.07793 14.6693 4.95041 14.4378 4.71892C14.2064 4.48747 14.0789 4.17965 14.0789 3.85222V1.46339ZM18.2995 18.9171C18.2995 19.593 17.7497 20.1428 17.0738 20.1428H3.92636C3.25046 20.1428 2.70061 19.593 2.70061 18.9171V2.08293C2.70065 1.40704 3.2505 0.857143 3.92636 0.857143H13.2218V3.85214C13.2217 4.40851 13.4383 4.93159 13.8317 5.32497C14.2251 5.71839 14.7482 5.93503 15.3046 5.93503H18.2995V18.9171H18.2995Z" fill="black"/>
                        ...
                        <div class="form-control-btn form-control-btn-fit work-mobile-btn">
                            <a class="btn-form-callback wrapper-callback-form-open" href="#callback">Заказать проект</a>
                        </div>
                    </div>
