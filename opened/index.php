                    ...
                    <div class="header header-colorize">
                        ...
                        <nav>
                            <ul class="menu">
                                ...
                                <li><a href="/services" class="active-menu-item">Услуги</a></li>
            ...
            <div class="container-menu-right">
                ...
                <div class="card-projects-navigate">
                    ...
                    <a href="" class="card-nav-link">
                        <div class="card-nav themes-transparent"></div>
                    </a>
                    <a href="" class="card-nav-link">
                        <div class="card-nav themes-transparent"></div>
                    </a>
                ...
                <div class="card-projects-navigate-bar">
                ...
                <!--					<div class="card-projects-navigate-bar-vertical hidden">-->
                <!--						<div class="current-progress">-->
                <!--							<div class="progress">-->
                <!--								<progress max="100" value="30"></progress>-->
                <!--								<div class="progress-bg" style="height: 130px;">-->
