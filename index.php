...
<div id="app-main">
    ...
    <div id="modal">
        <div class="hidden">
            <form  method="POST" id="callback" class="callback-form forms" enctype="multipart/form-data">
                ...
                <input name="strsite" type="hidden" value="главная страница сайта">
    ...
    <div class="screen">
        <div class="background-screen screen-page">
            ...
            <div class="menu-right menu-right-custom-control">
                ...
                <div class="container-menu-right container-menu-right-custom">
