<!-- Карты,которые подключены для проектов ,работающих в моб версии-->
...
<div class="js-page-scroll-section-projects">
  <a href="/project_11" class="card-nav-link openstr">
      <div class="card-nav themes-pink">
          <div class="card-project-nav-header">
              <h3 class="color-dark">Агенство &#8221;Gulf Stream&#8221;</h3>
          </div>
          <div class="downarrow">
              <p>Подробнее</p>
              <svg width="9" height="28" viewBox="0 0 9 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="js-page-scroll-section-projects">
  <a href="/project_12" class="card-nav-link openstr">
      <div class="card-nav themes-pink">
          <div class="card-project-nav-header">
              <h3 class="color-dark">Трансляции Perfecto</h3>
          </div>
          <div class="downarrow">
              <p>Подробнее</p>
              <svg width="9" height="28" viewBox="0 0 9 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="js-page-scroll-section-projects">
  <a href="/project_13" class="card-nav-link openstr">
      <div class="card-nav themes-pink">
          <div class="card-project-nav-header">
              <h3 class="color-dark">Провайдер &#8221;Etherway&#8221;</h3>
          </div>
          <div class="downarrow">
              <p>Подробнее</p>
              <svg width="9" height="28" viewBox="0 0 9 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="js-page-scroll-section-projects">
  <a href="/project_14" class="card-nav-link openstr">
      <div class="card-nav themes-pink">
          <div class="card-project-nav-header">
              <h3 class="color-dark">IMousse</h3>
          </div>
          <div class="downarrow">
              <p>Подробнее</p>
              <svg width="9" height="28" viewBox="0 0 9 27" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<div class="js-page-scroll-section-projects">
  <a href="/project_15" class="card-nav-link openstr">
      <div class="card-nav themes-pink">
          <div class="card-project-nav-header">
              <h3 class="color-dark">Djim Popo</h3>
          </div>
          <div class="downarrow">
              <p>Подробнее</p>
              <svg width="9" height="28" viewBox="0 0 9 27" fill="none" xmlns="http://www.w3.org/2000/svg">
